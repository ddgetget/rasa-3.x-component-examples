...
class RulePolicy(MemoizationPolicy):
    ...
    def get_default_config() -> Dict[Text, Any]:
        ...
        return {
            ...
            # Confidence of the prediction if no rule matched and de-facto threshold for a core fallback.
            # 如果没有匹配的规则，则预测的置信度和核心回退的事实阈值。
            ...
            # 如果“True”，则预测“core_fallback_action_name”，以防没有匹配的规则。
            ...
            # using the rules.
            # 如果“True”规则被限制为最多包含 1 条用户消息。这是为了避免用户使用规则构建状态机。
            "restrict_rules": True,
            ...
            # 策略将使用最新用户消息上的 NLU 置信度来设置操作的置信度
